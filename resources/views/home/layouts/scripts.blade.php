...
<script src="{{ asset('assets/js/bootstrap-select.min.js') }}"></script><!-- BOOTSTRAP SELECT -->
<script src="{{ asset('assets/js/jquery.bootstrap-touchspin.js') }}"></script><!-- FORM JS -->
...
<script src="{{ asset('assets/js/slick.min.js') }}"></script><!-- OWL  SLIDER  -->
...
<script src="{{ asset('assets/js/dropzone.js') }}"></script><!-- Images upload -->
...
<script src="{{ asset('assets/js/bootstrap-slider.min.js') }}"></script><!-- Form js -->
